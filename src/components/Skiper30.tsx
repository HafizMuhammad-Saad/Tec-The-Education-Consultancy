...
//   return (
//     <main className="w-full bg-[#000] text-black">
...
//           <span className="relative max-w-[12ch] text-xs uppercase leading-tight opacity-40 after:absolute after:left-1/2 after:top-full after:h-16 after:w-px after:bg-gradient-to-b after:from-black after:to-black after:content-['']">
//             scroll down to see
//           </span>
//         </div>
//       </div>
